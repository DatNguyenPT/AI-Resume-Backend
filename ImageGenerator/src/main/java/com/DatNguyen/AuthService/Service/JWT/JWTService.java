...
public class JWTService {
    ...
    // Token generate
    public String tokenGenerator(Map<String, Object> extraClaims, UserDetails userDetails, Duration time) {
        return Jwts
                .builder()
    ...
    public String tokenGenerator(UserDetails userDetails, Duration time){
